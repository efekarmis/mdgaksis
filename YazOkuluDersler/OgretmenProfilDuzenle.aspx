<%@ Page Title="Profili Düzenle" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="OgretmenProfilDuzenle.aspx.cs" Inherits="YazOkulu.OgretmenProfilDuzenle" %>
    ...
    <div class="container-fluid">
        <div class="profile-edit-card card-common">
            ...
            <div class="text-center mb-3">
                <asp:Image ID="imgMevcutFoto" runat="server" Height="150px" Width="150px" CssClass="profile-edit-photo" ImageUrl="~/OgretmenFotograflari/default_teacher.png" />
            </div>
            ...
            <asp:HiddenField ID="hdnOgretmenID" runat="server" />
