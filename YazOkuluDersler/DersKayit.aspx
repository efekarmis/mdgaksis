<%@ Page Title="Title" Language="C#" MasterPageFile="MasterPage.master" CodeBehind="DersKayit.aspx.cs" Inherits="YazOkuluDersler.DersKayit" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
        <form id="Form1" runat="server" class="container mt-5 p-4 border rounded bg-light">
            ...
            <div class="text-center">
                <asp:Button ID="Button1" runat="server" Text="Güncelle" OnClick="ButtonD_Click" CssClass="btn btn-primary w-100"/>
            </div>
        </form>
</asp:Content>