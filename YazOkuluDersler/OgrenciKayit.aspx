...
<%@ Page Title="Title" Language="C#" MasterPageFile="MasterPage.master" CodeBehind="OgrenciKayit.aspx.cs" Inherits="YazOkuluDersler.OgrenciKayit" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    <form id="Form1" runat="server" class="container mt-5 p-4 border rounded bg-light">
        <div class="form-group">
            <div class="mb-3">
                <asp:Label for="TextAd" runat="server" class="form-label" Text="Öğrenci Adı:"></asp:Label>
                <asp:TextBox ID="TextAd" runat="server" CssClass="form-control" placeholder="Adınızı giriniz"></asp:TextBox>
            </div>
            <br/>
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <asp:TextBox ID="TxtSifre" runat="server" CssClass="form-control" TextMode="Password" placeholder="Şifrenizi giriniz"></asp:TextBox>
            </div>
            <br/>
            <div class="mb-3">
        ...
        <div class="text-center">
            <asp:Button ID="Button1" runat="server" Text="Kaydet" OnClick="Button1_Click" CssClass="btn btn-primary w-100"/>
        </div>
    </form>
