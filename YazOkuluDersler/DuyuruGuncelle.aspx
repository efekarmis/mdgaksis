<%@ Page Title="Duyuru Güncelle" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="DuyuruGuncelle.aspx.cs" Inherits="YazOkulu.DuyuruGuncelle" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    <div class="container-fluid">
        <h2>Duyuru Güncelle</h2>
        <p class="text-muted">Mevcut duyurunun bilgilerini düzenleyin.</p>
        <hr />
        <div class="card card-common" style="max-width: 700px; margin: 20px auto;">
            <div class="card-body">
                <div class="mb-3">
                    ...
                    <asp:TextBox ID="txtBaslik" runat="server" CssClass="form-control" MaxLength="200" required="required"></asp:TextBox>
                ...
                <div class="mb-3">
                    ...
                    <asp:TextBox ID="txtIcerik" runat="server" CssClass="form-control" TextMode="MultiLine" Rows="5" required="required"></asp:TextBox>
                ...
                <div class="text-end border-top pt-3 mt-2">
                    <asp:Button ID="btnDuyuruGuncelle" runat="server" Text="Değişiklikleri Kaydet" CssClass="btn btn-primary me-2" OnClick="btnDuyuruGuncelle_Click" />
                ...
                <asp:HiddenField ID="hdnDuyuruID" runat="server" />
            </div>
        </div>
    </div>
</asp:Content>
